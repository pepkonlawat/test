...
class BaseOptions():
    ...
    def initialize(self):
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='./datasets/males/')#'0-2,3-6,7-9,15-19,30-39,50-69'
        self.parser.add_argument('--sort_classes', type=bool, default=True, help='a flag that indicates whether to sort the classes')
        self.parser.add_argument('--sort_order', type=str, default='0-2', help='a specific order to sort the classes, must contain all classes, only works when sort_classes is true')
