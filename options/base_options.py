...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--sort_order', type=str, default='0-2,3-6,7-9,15-19', help='a specific order to sort the classes, must contain all classes, only works when sort_classes is true')
